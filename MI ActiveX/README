# MI ACTIVEX
Hi there !
i build this programm because i wanted to discuss discretely with colleagues in my office.
With it, I seat up a BBD in a folder places in the network of our office that is open to write and read files.
we can only use this programm in Internet Explorer with the plugin ActiveX activated
