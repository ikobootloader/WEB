...
- Refactor sans impact fonctionnel:
  ...
  - suppression des trois anciens fichiers 	askmda-doc-*.
...
### Nouvelle fonctionnalitÃƒÆ’Ã‚Â© - Avril 2026 (Surveillance de fichiers)

- **RÃƒÆ’Ã‚Â©fÃƒÆ’Ã‚Â©rentiels / Surveillance fichiers**:
  - ajout d'un nouvel onglet `Surveillance fichiers` dans la section RÃƒÆ’Ã‚Â©fÃƒÆ’Ã‚Â©rentiels,
  - crÃƒÆ’Ã‚Â©ation d'observateurs pour surveiller automatiquement les modifications de fichiers dans un dossier,
  - systÃƒÆ’Ã‚Â¨me de polling configurable (intervalle de 30 secondes ÃƒÆ’Ã‚Â  1 heure),
  - dÃƒÆ’Ã‚Â©tection de 3 types d'ÃƒÆ’Ã‚Â©vÃƒÆ’Ã‚Â©nements: crÃƒÆ’Ã‚Â©ation, modification, suppression de fichiers,
  - support de multiples formats de fichiers:
    ...
    - Patterns personnalisÃƒÆ’Ã‚Â©s (ex: `rapport_*.pdf`)
  - mode rÃƒÆ’Ã‚Â©cursif pour observer les sous-dossiers,
  - notifications automatiques intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â©es au centre de notifications,
  - configuration fine des notifications par type d'ÃƒÆ’Ã‚Â©vÃƒÆ’Ã‚Â©nement,
  - interface complÃƒÆ’Ã‚Â¨te:
    - liste en cartes avec statut visuel (actif/pausÃƒÆ’Ã‚Â©),
    - modale de crÃƒÆ’Ã‚Â©ation/ÃƒÆ’Ã‚Â©dition avec sÃƒÆ’Ã‚Â©lection de dossier (File System Access API),
    - modale de dÃƒÆ’Ã‚Â©tail avec:
      - informations (statut, frÃƒÆ’Ã‚Â©quence, rÃƒÆ’Ã‚Â©cursif, derniÃƒÆ’Ã‚Â¨re vÃƒÆ’Ã‚Â©rification),
      - actions rapides (pause/reprise, vÃƒÆ’Ã‚Â©rification manuelle, modifier, supprimer),
      - liste des fichiers surveillÃƒÆ’Ã‚Â©s (nom, taille),
      - historique complet des changements avec filtres (tous, crÃƒÆ’Ã‚Â©ÃƒÆ’Ã‚Â©s, modifiÃƒÆ’Ã‚Â©s, supprimÃƒÆ’Ã‚Â©s),
  - modules autonomes:
    - `js/taskmda-file-watcher.js`: moteur de surveillance (polling, dÃƒÆ’Ã‚Â©tection, notifications),
  ...
  - migration DB_VERSION 21 avec 3 nouveaux stores IndexedDB:
    ...
    - `fileWatcherSnapshots`: ÃƒÆ’Ã‚Â©tat de rÃƒÆ’Ã‚Â©fÃƒÆ’Ã‚Â©rence des fichiers (mÃƒÆ’Ã‚Â©tadonnÃƒÆ’Ã‚Â©es),
    - `fileWatcherEvents`: historique des changements dÃƒÆ’Ã‚Â©tectÃƒÆ’Ã‚Â©s,
  - documentation complÃƒÆ’Ã‚Â¨te:
...
- Workflow:
  ...
  - ajout d un bouton admin `Activer/DÃƒÆ’Ã‚Â©sactiver mode seed`.
...
### ÃƒÂ¢Ã…â€œÃ‚Â¨ Nouvelles fonctionnalitÃƒÆ’Ã‚Â©s
...
#### ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬Å¾ RÃƒÆ’Ã‚Â©currence des tÃƒÆ’Ã‚Â¢ches
- **TÃƒÆ’Ã‚Â¢ches rÃƒÆ’Ã‚Â©currentes** : CrÃƒÆ’Ã‚Â©ation de tÃƒÆ’Ã‚Â¢ches qui se rÃƒÆ’Ã‚Â©pÃƒÆ’Ã‚Â¨tent automatiquement
- **Types de rÃƒÆ’Ã‚Â©currence** :
  - Hebdomadaire (avec sÃƒÆ’Ã‚Â©lection de plusieurs jours)
  - Mensuelle (avec sÃƒÆ’Ã‚Â©lection de plusieurs jours du mois)
  - Annuelle (avec sÃƒÆ’Ã‚Â©lection de plusieurs dates MM-DD)
- **Options de fin** :
  - Infini : RÃƒÆ’Ã‚Â©currence sans limite
  - Nombre d'occurrences : DÃƒÆ’Ã‚Â©fini le nombre de fois que la tÃƒÆ’Ã‚Â¢che se rÃƒÆ’Ã‚Â©pÃƒÆ’Ã‚Â¨te
  - Jusqu'ÃƒÆ’Ã‚Â  une date : Termine la rÃƒÆ’Ã‚Â©currence ÃƒÆ’Ã‚Â  une date spÃƒÆ’Ã‚Â©cifiÃƒÆ’Ã‚Â©e
- **Intervalles personnalisables** : Configuration du nombre de pÃƒÆ’Ã‚Â©riodes (1, 2, 3, etc.)
- **Interface intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â©e** : Formulaire de configuration dans le modal de tÃƒÆ’Ã‚Â¢che
- **Compatible** : TÃƒÆ’Ã‚Â¢ches de projet et tÃƒÆ’Ã‚Â¢ches hors projet (global)
- **Synchronisable** : RÃƒÆ’Ã‚Â©currence persistÃƒÆ’Ã‚Â©e et synchronisÃƒÆ’Ã‚Â©e en mode collaboratif

### ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã‚Â Nouveaux fichiers
- `js/taskmda-recurrence.js` - Moteur de rÃƒÆ’Ã‚Â©currence et utilitaires
- `js/taskmda-recurrence-ui.js` - Gestion UI et formulaire
- `docs/RECURRENCE.md` - Documentation technique complÃƒÆ’Ã‚Â¨te
- `docs/QUICKSTART_RECURRENCE.md` - Guide rapide et exemples

### ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬Â¹ Anciennes nouvelles - Mars 2026

### ÃƒÂ¢Ã…â€œÃ‚Â¨ Anciennes fonctionnalitÃƒÆ’Ã‚Â©s

#### Chiffrement E2E et projets privÃƒÆ’Ã‚Â©s/partagÃƒÆ’Ã‚Â©s
- **Projets privÃƒÆ’Ã‚Â©s** : StockÃƒÆ’Ã‚Â©s localement uniquement, non synchronisÃƒÆ’Ã‚Â©s
- **Projets partagÃƒÆ’Ã‚Â©s** : Synchronisation avec chiffrement E2E (AES-256-GCM)
- **Passphrase optionnelle** : Facilite le partage entre collaborateurs
- **Double chiffrement** : Local (mot de passe utilisateur) + Transport (clÃƒÆ’Ã‚Â© partagÃƒÆ’Ã‚Â©e)
- **Badges visuels** : ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢ PRIVÃƒÆ’Ã¢â‚¬Â° vs ÃƒÂ°Ã…Â¸Ã¢â‚¬ËœÃ‚Â¥ PARTAGÃƒÆ’Ã¢â‚¬Â° ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â

#### AmÃƒÆ’Ã‚Â©lioration UX
- **ÃƒÆ’Ã¢â‚¬Â°dition du nom d'utilisateur** : Clic sur icÃƒÆ’Ã‚Â´ne crayon dans l'en-tÃƒÆ’Ã‚Âªte
- **Interface de crÃƒÆ’Ã‚Â©ation** : Choix du mode (privÃƒÆ’Ã‚Â©/partagÃƒÆ’Ã‚Â©) avec radio buttons
- **Champ passphrase** : AffichÃƒÆ’Ã‚Â© conditionnellement pour projets partagÃƒÆ’Ã‚Â©s

### ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â§ AmÃƒÆ’Ã‚Â©liorations techniques

#### Base de donnÃƒÆ’Ã‚Â©es
- **Store `sharedKeys`** : AjoutÃƒÆ’Ã‚Â© pour stocker les clÃƒÆ’Ã‚Â©s partagÃƒÆ’Ã‚Â©es (chiffrÃƒÆ’Ã‚Â©es)
- **DB_VERSION 3** : Migration automatique

#### Synchronisation
- **Chargement automatique** : DÃƒÆ’Ã‚Â©couverte des projets existants lors de la connexion
- **Chiffrement E2E** : Tous les ÃƒÆ’Ã‚Â©vÃƒÆ’Ã‚Â©nements synchronisÃƒÆ’Ã‚Â©s sont chiffrÃƒÆ’Ã‚Â©s
- **Format v1-e2e-encrypted** : Nouveau format pour les fichiers du dossier partagÃƒÆ’Ã‚Â©
- **RÃƒÆ’Ã‚Â©trocompatibilitÃƒÆ’Ã‚Â©** : Support des anciens fichiers JSON en clair

#### Module crypto
- 6 nouvelles fonctions pour chiffrement E2E :
  - `generateSharedKey()` - GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ration clÃƒÆ’Ã‚Â© AES-256
  - `exportSharedKey()` / `importSharedKey()` - Import/export
  - `deriveSharedKeyFromPassphrase()` - DÃƒÆ’Ã‚Â©rivation PBKDF2
  - `encryptWithSharedKey()` / `decryptWithSharedKey()` - Chiffrement/dÃƒÆ’Ã‚Â©chiffrement

### ÃƒÂ°Ã…Â¸Ã‚ÂÃ¢â‚¬Âº Corrections

#### Synchronisation multi-postes
- **Fix** : Les projets existants sont maintenant chargÃƒÆ’Ã‚Â©s lors de la connexion
- **Fonction** : `discoverAndLoadExistingProjects()` ajoutÃƒÆ’Ã‚Â©e
- **ParamÃƒÆ’Ã‚Â¨tre** : `onlyNew` dans `readEventsFromSharedFolder()`

#### UUID
- **Fix** : ImplÃƒÆ’Ã‚Â©mentation UUID en ligne (ÃƒÆ’Ã‚Â©limination dÃƒÆ’Ã‚Â©pendance CDN)

#### Base de donnÃƒÆ’Ã‚Â©es
- **Fix** : Pattern singleton pour ÃƒÆ’Ã‚Â©viter les fermetures de connexion
- **Fix** : `getDatabase()` synchrone

### ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã…Â¡ Documentation

- README.md : Section sÃƒÆ’Ã‚Â©curitÃƒÆ’Ã‚Â© complÃƒÆ’Ã‚Â¨te et synthÃƒÆ’Ã‚Â©tique
- CHIFFREMENT_INDEXEDDB.md : Architecture technique dÃƒÆ’Ã‚Â©taillÃƒÆ’Ã‚Â©e
- TEST_CHIFFREMENT.md : Plan de test avec 14 scÃƒÆ’Ã‚Â©narios
- PROJET.md : SpÃƒÆ’Ã‚Â©cifications event-sourcing

### ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â SÃƒÆ’Ã‚Â©curitÃƒÆ’Ã‚Â©

- **Aucune donnÃƒÆ’Ã‚Â©e en clair** : Tout est chiffrÃƒÆ’Ã‚Â© (local + transport)
- **Zero-knowledge** : Le dossier partagÃƒÆ’Ã‚Â© ne contient que des donnÃƒÆ’Ã‚Â©es chiffrÃƒÆ’Ã‚Â©es
- **ClÃƒÆ’Ã‚Â©s en mÃƒÆ’Ã‚Â©moire** : Jamais stockÃƒÆ’Ã‚Â©es sur disque
- **Standards** : AES-256-GCM, PBKDF2-SHA256, OWASP 2024

---

## Prochaines ÃƒÆ’Ã‚Â©volutions possibles

- Modal "Rejoindre un projet partagÃƒÆ’Ã‚Â©" avec scanner automatique
- Export/import de clÃƒÆ’Ã‚Â©s (.key file)
- Gestion des clÃƒÆ’Ã‚Â©s partagÃƒÆ’Ã‚Â©es (interface dÃƒÆ’Ã‚Â©diÃƒÆ’Ã‚Â©e)
- Rotation des clÃƒÆ’Ã‚Â©s
- RÃƒÆ’Ã‚Â©vocation de membres
- Notifications en temps rÃƒÆ’Ã‚Â©el
