...
class Agent {
	constructor(x, y, health, color, config, width, height, state, elements, isObstacle, isReward, drawAgent, clearAgent, updateVisitedPositions, discoverSurroundings, propagateValues) {
        this.x = x;
        this.y = y;
        this.health = health;
        this.color = color;
