...
function updateEquilibriumInfo(duree) {
    ...
    let infoText = `
        <h3>
            Points d'équilibre ETP productif = ETP homéostasique théorique
            <span class="info-icon tooltip">ℹ️
                <span class="tooltiptext">L'ETP homéostasique théorique représente l'état d'équilibre stable où la productivité de l'équipe atteint son niveau optimal et se maintient.</span>
            </span>
        </h3>`;
